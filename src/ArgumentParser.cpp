...
ArgumentParser::ArgumentParser(const std::string & name, int argc, const char * const *argv, SelectFunc selFunc, EditFunc editFunc,
        CheckFunc checkFunc) :
        m_app { name },  //
        m_argc { argc }, //
        m_argv { argv }, //
    ...
    m_selectCommand->callback([this] () {
        ...
        std::cout << "Calling select binding." << std::endl;
    ...
    m_editCommand->callback([this] () {
        ...
        std::cout << "Calling edit binding." << std::endl;
    ...
    m_checkCommand->callback([this] () {
        ...
        std::cout << "Calling check binding." << std::endl;
